...
INSERT INTO product_harmony (id_product, id_harmony) VALUES (16, 17);create table category (id integer not null auto_increment, name varchar(255), primary key (id)) engine=MyISAM;
